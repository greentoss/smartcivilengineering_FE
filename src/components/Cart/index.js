                                            ...
                                            <div className="d-flex justify-content-between align-items-center mb-4">
                                                ...
                                                <div>
                                                    <p className="mb-0"><span className="text-muted">Sort by:</span> <a
                                                        href="#"
                                                        className="text-body">price <i className="fas fa-angle-down mt-1"/></a></p>
                                                </div>
                                            </div>
                                                ...
                                                <div className="card-body">
                                                    <div className="d-flex justify-content-between">
                                                        <div className="d-flex flex-row align-items-center">
                                                            <div>
                                                                <img
                                                                    ...
                                                                    className="img-fluid rounded-3 shop-item-img" alt="Shopping item"/>
                                                            </div>
                                                            <div className="ms-3">
                                                                <h5>Iphone 11 pro</h5>
                                                        ...
                                                        <div className="d-flex flex-row align-items-center">
                                                            ...
                                                            <a href="#" ><i className="fas fa-trash-alt trash"/></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
