            ...
            <div className={headerStyle.header}>
                <div className="container" >
                    <div className="row justify-content-between align-items-center pt-3 pb-3" >
                        <div className='row font-weight-bold col-6 p-0 pl-5'>
                        ...
                        <nav className="navbar navbar-expand-lg navbar-light col-6">
                            ...
                            <div className="collapse navbar-collapse d-flex justify-content-end" id="navbarNavAltMarkup">
                                <div className="navbar-nav">
                                    ...
                                    <li className='ml-4'>< Link to='/'><a href="#contact" className='nav-item nav-link btn-lg text-white bg-dark'>Contacts</a></Link></li>
                                </div>
